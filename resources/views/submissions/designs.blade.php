                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="newDesignModalLabel">New Design Submission</h5>
                                    ...
                                    <form action="{{ route('designs.store') }}" method="POST"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="js-example-basic-multiple myselect2" name="related[]"
                                                ...
                                                <div class="modal fade" id="editModal{{ $submission->id }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                action="{{ route('designs.update', ['id' => $submission->id]) }}"
