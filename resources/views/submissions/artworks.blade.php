                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#newArtworkModal">
                            <i class="ti ti-plus"></i> New Artwork
                        </button>

                        <!-- New Artwork Modal -->
                        <div class="modal fade" id="newArtworkModal" tabindex="-1"
                            aria-labelledby="newArtworkModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="newArtworkModalLabel">New Artwork Submission</h5>
                                    ...
                                    <form action="{{ route('artworks.store') }}" method="POST"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control myselect2" id="project" name="project"
                            ...
                            <tbody>
                                @foreach ($submissions as $submission)
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('submission.view') }}?id={{ $submission->id }}">{{ $submission->title }}</a>
                                        </td>
                                        ...
                                        <td><a href="{{ asset($submission->file) }}"
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="imageModal{{ $submission->id }}" tabindex="-1"
                                                aria-labelledby="imageModalLabel{{ $submission->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="imageModalLabel{{ $submission->id }}">Artwork Image
                                                            </h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body text-center">
                                                            <img src="{{ asset($submission->file) }}"
                                                                alt="Artwork Image" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            @if (
                                                ...
                                                <!-- Edit Modal -->
                                                <div class="modal fade" id="editModal{{ $submission->id }}"
                                                    tabindex="-1"
                                                    aria-labelledby="editModalLabel{{ $submission->id }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="editModalLabel{{ $submission->id }}">Edit
                                                                    Submission</h5>
                                                                <button type="button" class="btn-close"
                                                            ...
                                                            <form
                                                                action="{{ route('artworks.update', ['id' => $submission->id]) }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="file{{ $submission->id }}"
                                                                            class="form-label">Reupload File</label>
                                            ...
                                            @if (
                                                ...
                                                <form
                                                    action="{{ route('submission.approve', ['id' => $submission->id]) }}"
                                                ...
                                                <form
                                                    action="{{ route('submission.reject', ['id' => $submission->id]) }}"
                                                    method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('POST')
